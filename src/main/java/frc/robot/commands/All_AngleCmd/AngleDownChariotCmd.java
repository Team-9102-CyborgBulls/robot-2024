...
public class AngleDownChariotCmd extends Command { // Déclaration de la classe AngleDownManualCmd qui étend la classe Command
    ...
    public AngleDownChariotCmd(AngleSubsystem angle) { // Constructeur de la classe AngleDownManualCmd
    ...
    public boolean isFinished() { // Méthode qui indique si la commande est terminée
        if(m_robotContainer.Potentio.getValue() <= 3275){
            return true;
