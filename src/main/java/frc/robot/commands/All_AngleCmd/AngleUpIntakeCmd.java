...
public class AngleUpIntakeCmd extends Command { // Déclaration de la classe AngleUpManualCmd qui étend la classe Command
    ...
    public AngleUpIntakeCmd(AngleSubsystem anglesubsystem) { // Constructeur de la classe AngleUpManualCmd
