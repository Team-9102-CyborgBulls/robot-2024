...
public class AngleUpChariotCmd extends Command { // Déclaration de la classe AngleDownManualCmd qui étend la classe Command
    ...
    public AngleUpChariotCmd(AngleSubsystem angle) { // Constructeur de la classe AngleDownManualCmd
    ...
    public boolean isFinished() { // Méthode qui indique si la commande est terminée
        if(m_robotContainer.Potentio.getValue() >= 3265){
            return true;
