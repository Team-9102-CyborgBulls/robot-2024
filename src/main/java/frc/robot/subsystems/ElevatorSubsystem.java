...
public class ElevatorSubsystem extends SubsystemBase { // Déclaration de la classe ElevatorSubsystem qui étend la classe SubsystemBase
    ...
    //RelativeEncoder m_encoder; // Déclaration d'une variable m_encoder de type RelativeEncoder pour l'encodeur du NEO 
    public static DutyCycleEncoder ElevatorEncoder = new DutyCycleEncoder(0); //Rev Through Bore Encoder
